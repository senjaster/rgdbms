...
run "ydb-bench --endpoint grpcs://entrypoint.ydb-cluster.com:2135 --database /Root/database --ca-file ~/ca.crt --user root --scale 1 run --jobs 1 -P 10 -T 30 --file ${SCRIPT_DIR}/multi_partition_txn.sql &"
WORKLOAD_PID=$!
