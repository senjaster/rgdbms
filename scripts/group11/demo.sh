...
comment "В случае, если СУБД в рамках одного инстанса/кластера, может управлять несколькими БД "
comment "одновременно, встроенные средства резервного копирования позволяют проводить операции "
comment "восстановления отдельной БД в новый кластер/инстанс СУБД"
comment ""
