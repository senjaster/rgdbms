...
comment "Формально, у YDB нет понятия мастер, однако вот описание критерия из ПМИ:"
comment "---"
comment "Кластер обеспечивает масштабируемость OLTP для читающих транзакций, "
comment "а также высокую степень доступности с автоматическим восстановлением после сбоев"

comment "По совокупности всех предыдущих демо можно утверждать что YDB удовлетворяет этому критерию."
